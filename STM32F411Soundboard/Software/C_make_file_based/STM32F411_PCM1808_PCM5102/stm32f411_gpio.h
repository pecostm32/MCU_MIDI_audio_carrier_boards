...
#ifndef __STM32F411_GPIO_H_
#define __STM32F411_GPIO_H_
...
typedef struct
{
  __IO uint32 MODER;    //GPIO port mode register
  __IO uint32 OTYPER;   //GPIO port output type register
  __IO uint32 OSPEEDR;  //GPIO port output speed register
  __IO uint32 PUPDR;    //GPIO port pull-up/pull-down register
  __IO uint32 IDR;      //GPIO port input data register
  __IO uint32 ODR;      //GPIO port output data register
  __IO uint32 BSRR;     //GPIO port bit set/reset register
  __IO uint32 LCKR;     //GPIO port configuration lock register
  __IO uint32 AFR[2];   //GPIO alternate function registers
} GPIO_TypeDef;
...
#define GPIO_OUTPUT_PP_FAST_SPEED         0x00000201
...
#define GPIO_OUTPUT_PP_PU_FAST_SPEED      0x00001201
...
#define GPIO_OUTPUT_PP_PD_FAST_SPEED      0x00002201
...
#define GPIO_OUTPUT_OD_FAST_SPEED         0x00000211
...
#define GPIO_OUTPUT_OD_PU_FAST_SPEED      0x00001211
...
#define GPIO_OUTPUT_OD_PD_FAST_SPEED      0x00002211
...
#define GPIO_AF_PP_FAST_SPEED             0x00000202
...
#define GPIO_AF_PP_PU_FAST_SPEED          0x00001202
...
#define GPIO_AF_PP_PD_FAST_SPEED          0x00002202
...
#define GPIO_AF_OD_FAST_SPEED             0x00000212
...
#define GPIO_AF_OD_PU_FAST_SPEED          0x00001212
...
#define GPIO_AF_OD_PD_FAST_SPEED          0x00002212
#define GPIO_AF_OD_PD_HIGH_SPEED          0x00002312

//Alternate function input requires setting as output
#define GPIO_AF_INPUT                     0x00000002
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_MODER register
//----------------------------------------------------------------------------------------------------------------------------------

#define GPIO_MODER_MODE0                 0x00000003
#define GPIO_MODER_MODE0_0               0x00000001
#define GPIO_MODER_MODE0_1               0x00000002
#define GPIO_MODER_MODE1                 0x0000000C
#define GPIO_MODER_MODE1_0               0x00000004
#define GPIO_MODER_MODE1_1               0x00000008
#define GPIO_MODER_MODE2                 0x00000030
#define GPIO_MODER_MODE2_0               0x00000010
#define GPIO_MODER_MODE2_1               0x00000020
#define GPIO_MODER_MODE3                 0x000000C0
#define GPIO_MODER_MODE3_0               0x00000040
#define GPIO_MODER_MODE3_1               0x00000080
#define GPIO_MODER_MODE4                 0x00000300
#define GPIO_MODER_MODE4_0               0x00000100
#define GPIO_MODER_MODE4_1               0x00000200
#define GPIO_MODER_MODE5                 0x00000C00
#define GPIO_MODER_MODE5_0               0x00000400
#define GPIO_MODER_MODE5_1               0x00000800
#define GPIO_MODER_MODE6                 0x00003000
#define GPIO_MODER_MODE6_0               0x00001000
#define GPIO_MODER_MODE6_1               0x00002000
#define GPIO_MODER_MODE7                 0x0000C000
#define GPIO_MODER_MODE7_0               0x00004000
#define GPIO_MODER_MODE7_1               0x00008000
#define GPIO_MODER_MODE8                 0x00030000
#define GPIO_MODER_MODE8_0               0x00010000
#define GPIO_MODER_MODE8_1               0x00020000
#define GPIO_MODER_MODE9                 0x000C0000
#define GPIO_MODER_MODE9_0               0x00040000
#define GPIO_MODER_MODE9_1               0x00080000
#define GPIO_MODER_MODE10                0x00300000
#define GPIO_MODER_MODE10_0              0x00100000
#define GPIO_MODER_MODE10_1              0x00200000
#define GPIO_MODER_MODE11                0x00C00000
#define GPIO_MODER_MODE11_0              0x00400000
#define GPIO_MODER_MODE11_1              0x00800000
#define GPIO_MODER_MODE12                0x03000000
#define GPIO_MODER_MODE12_0              0x01000000
#define GPIO_MODER_MODE12_1              0x02000000
#define GPIO_MODER_MODE13                0x0C000000
#define GPIO_MODER_MODE13_0              0x04000000
#define GPIO_MODER_MODE13_1              0x08000000
#define GPIO_MODER_MODE14                0x30000000
#define GPIO_MODER_MODE14_0              0x10000000
#define GPIO_MODER_MODE14_1              0x20000000
#define GPIO_MODER_MODE15                0xC0000000
#define GPIO_MODER_MODE15_0              0x40000000
#define GPIO_MODER_MODE15_1              0x80000000
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_OTYPER register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_OSPEEDR register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_PUPDR register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_IDR register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_ODR register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_BSRR register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_LCKR register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_AFRL register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_AFRH register
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
//Bit definition(s) for GPIO_BRR register
//----------------------------------------------------------------------------------------------------------------------------------
