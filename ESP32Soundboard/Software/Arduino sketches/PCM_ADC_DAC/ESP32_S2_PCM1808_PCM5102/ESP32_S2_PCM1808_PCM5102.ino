//The S2 board needs a reset after programming to make it work
//To allow programming a reset with boot switch pressed is needed


#include <ESP_I2S.h>

const uint8_t I2S_MCLK = 34;
const uint8_t I2S_BCLK = 36;
const uint8_t I2S_WS   = 38;
const uint8_t I2S_DIN  = 17;  //(From PCM1808)
const uint8_t I2S_DOUT = 21;  //(To   PCM5102)
...
const int sampleRate = 96000;  // sample rate in Hz
